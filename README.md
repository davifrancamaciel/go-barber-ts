# go-barber-ts
✂️ GobBarber - desenvolvido Typescript  durante a GoStack 11. Trata-se de um projeto fullstack para uma barbearia ficticia, a GoBarber
...
$ git clone https://github.com/davifrancamaciel/go-barber-ts.git
